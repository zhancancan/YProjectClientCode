Shader "Pure/Skinnable/Diffuse" {
	Properties { 	  	
		...
		[HideInInspector][Toggle(OVER_DRAW)] _rim ("OverDraw Enabled",Float)=0 
		[HideInInspector]_OverDrawColor("OverDraw Color", Color) = (0,0,0,0)
		[HideInInspector]_OverDrawPower("OverDraw Power",Range(0.000001,3.0)) =0.1
	...
	SubShader {
		...
		Pass {
			...
			CGPROGRAM 
				#include "skin_diffuse.cginc"
				#pragma vertex vert
				#pragma fragment frag   
				#pragma multi_compile BASE _SKIN_L0 _SKIN_L1 _SKIN_L2 _SKIN_L3 _SKIN_L4   		 
